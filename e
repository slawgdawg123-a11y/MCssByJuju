...
@container root style(--colors: on) {
    ...
    .theme-light:not(.custom-user-profile-theme) {
        ...
        --control-brand-foreground-new: White;
        ...
        --mobile-background-scrim-opaque: white;
        ...
        --scrollbar-auto-scrollbar-color-track: White;
        ...
        --user-profile-note-background-focus: White;
